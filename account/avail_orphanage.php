...
<head>
    <title>Available Orphanage || Orphanage management system </title>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Available Orphanage</h5>
                            </div>
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">Available Orphanage</li>
                ...
                <div class="table-responsive">
                    <table id="main_table" class="table table-hover" style="width: 100%;">
                        ...
                        <tbody>
                            <?php
                                $rc=0;
                                $sql = "SELECT orp_id, name, dob, gender FROM orp_details WHERE status=0";
                                $result = mysqli_query($conn,$sql);
                                while($row = mysqli_fetch_assoc($result)){
                                    $rc+=1;
                                    echo "<tr>";
