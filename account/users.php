            ...
            <div class="modal-content">
                <form action="" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <p class="text-center fs-5 text-danger"> Are you sure Want to delete User Data.</p>
                        </div>
                    </div>
                ...
                <div class="table-responsive">
                    <table id="main_table" class="table table-hover" style="width: 100%;">
                        ...
                        <tbody>
                            <?php
                            $rc=0;
                            $sql = "SELECT admin_id, name, father_name, address, mobile_no, email FROM orp_admin WHERE acc_type = 1";
                            $result = mysqli_query($conn,$sql);
                            while($row = mysqli_fetch_assoc($result)){
                                $rc+=1;
                                echo "<tr>";
