<?php
    ...
    if (isset($_POST["verify_data_submit"])){
        $donation_id_modal=$_POST["donation_id_modal"];
        $sql="UPDATE orp_donation SET status='1' WHERE donation_id='$donation_id_modal'";
...
<body class="">
    ...
    <!-- [ Header ] end -->
    <!-- ------------------------------------- verify Modal ------------------------------------- -->
    <div class="modal" id="verify_donation_data_modal" tabindex="-1" aria-labelledby="verify_don_data" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="" method="POST">
                    <input type="hidden" name="donation_id_modal" id="donation_id_modal">
                    <div class="modal-header">
                        <h5 class="modal-title" id="verify_don_data">Verify Donation</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" data-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <p class="text-center fs-5 text-danger"> Are you sure to verify this Payment.</p>
                        </div>
                    </div>
                ...
                <div class="table-responsive">
                    <table id="main_table" class="table table-hover" style="width: 100%;">
                        ...
                        <tbody>
                            <?php
                                $rc=0;
                                $sql = "SELECT donation_id,date, method_of_pay, total_amount, tnx_id, donate_by, status, user_id FROM orp_donation";
                                $result = mysqli_query($conn,$sql);
                                while($row = mysqli_fetch_assoc($result)){
                                    $rc+=1;
                                    echo "<tr>";
